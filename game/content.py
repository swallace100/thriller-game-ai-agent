...
# A one-liner the player sees as soon as the app opens
NARRATOR_INTRO = (
    "The elevator dings. Emergency lights stutter to life. Somewhere below, a door "
    "slams. Your phone vibrates once. An unknown number. You have ten seconds to decide."
)
